...
Handler: co.cookies.worker.BookRequestHandler
...
### Verification
From the workflow step `Deploy Cloud Run` copy out url `https://scim-gateway-__________run.app` of the invoke endpoint:
```
Invoke endpoint:
https://scim-gateway-__________run.app
```

Call the api endpoint:
```
curl https://scim-gateway-__________run.app/scimGateway
```
